...
@implementation ImmosudAppDelegate
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"Immosud.sqlite"];
	...
	defaultStorePath = [[NSBundle mainBundle] pathForResource:@"Immosud" ofType:@"sqlite"];
